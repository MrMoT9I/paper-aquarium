...
(function () {
  ...
  var DICT = {
    ru: {
      ...
      'home.ios.title': 'Аквариум для iPhone и iPad',
      'home.ios.sub': 'То же самое, но работает без интернета',
      ...
      'home.author': 'Автор проекта',
      'home.author.chat': 'Чат проекта',
    ...
    en: {
      ...
      'home.ios.title': 'Aquarium for iPhone and iPad',
      'home.ios.sub': 'The same thing, but it works without the internet',
      ...
      'home.author': 'Project author',
      'home.author.chat': 'Project chat',
    ...
    pl: {
      ...
      'home.ios.title': 'Akwarium na iPhone’a i iPada',
      'home.ios.sub': 'To samo, ale działa bez internetu',
      ...
      'home.author': 'Autor projektu',
      'home.author.chat': 'Czat projektu',
